      ...
      <div className="contact-content">
        <div className="contact-info">
          ...
          <div className="info-item">
            ...
            <div>
              <h3>Email</h3>
              <p>mrgaurishankarkhadga@gmail.com</p>
            </div>
          </div>
          ...
          <div className="info-item">
            ...
            <div>
              <h3>Location</h3>
              <p>PARUL UNIVERSITY, VADODARA, GUJRAT, INDIA</p>
            </div>
          </div>
          ...
          <div className="social-links">
            ...
            <div className={`animated social-links-container ${'f' ? 'show' : ''}`}>
              <a href="https://github.com/gaurishankarkhadga" target="_blank" rel="noopener noreferrer" className="social-link github">

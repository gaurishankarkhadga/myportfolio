          ...
          <div className="hero-content">
            ...
            <div className="animated info-box">
              <p className="sub-tagline">
                <strong>E</strong>ngineering <strong>I</strong>ntellect <strong>W</strong>here <strong>D</strong>eep <strong>L</strong>earning <strong>A</strong>lgorithms <strong>M</strong>eet <strong>S</strong>calable <strong>A</strong>rchitectures.
              </p>
            </div>

            <div className="animated cta-container" style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap', marginTop: '1.5rem' }}>
              {/* <a href="/resume.html" target="_blank" rel="noopener noreferrer" className="view-resume-btn">
                <span>View Resume</span>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
              </a> */}
              <div className="animated social-links-container" style={{ marginTop: 0 }}>
                ...
                <div className="social-link-wrapper">
                  <a href="https://leetcode.com/u/ggs699000" target="_blank" rel="noopener noreferrer" className="social-link leetcode">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="white">
                ...
                <div className="social-link-wrapper">
                  <a href="https://tiktok.com/gshankar413" target="_blank" rel="noopener noreferrer" className="social-link tiktok">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="white">
